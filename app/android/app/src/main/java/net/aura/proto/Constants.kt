...
const val MSG_FLAGS_IPV6_MASK : Byte = 0b00010000

const val MSG_FLAGS_TYPE_DIRECT: Byte = 0b00
const val MSG_FLAGS_TYPE_BROADCAST: Byte = 0b01
const val MSG_FLAGS_TYPE_NODE_ADV: Byte = 0b10
...
//NODE_ADV MESSAGE
//|ip_address(4|16)|port(2)| (ip_version in flags)
...
const val MSG_DETAILS_COUNTERLENGTH = MSG_FLAGS_LENGTH + MSG_TIME_LENGTH + MSG_NONCE_LENGTH
